...
inline const Glyph5x7 &fallbackGlyph() {
  static const Glyph5x7 glyph = {{0x0E, 0x11, 0x01, 0x02, 0x04, 0x00, 0x04}};
  return glyph;
}

inline const Glyph5x7 &lookupGlyph5x7(char value) {
  ...
  const unsigned int ascii = static_cast<unsigned char>(value);
  if (ascii < 32 || ascii > 126) {
    return fallbackGlyph();
  }

  return glyphs[ascii - 32];
}
