...
#include "../device_driver/bcm/bcm2xxx_i2c.hpp"
...
#include "../device_driver/lcd/touch_controller.hpp"
#include <bsp/bsp.hpp>
...
public:
  ...
  static Driver::BSP::BCM::I2C *getI2C();
  ...
  static Driver::BSP::Touch::TouchPanel *getTouchPanel();
...
private:
  ...
  static Driver::BSP::Touch::TouchPanel *touchPanel;
  ...
  static void postInitI2C();
  static void postInitSPI0();
  static void postInitDisplay();
  static void postInitTouchPanel();
