...
SRCS = ./src/main.cpp $(STD_SRCS) $(ARCH_SRCS) $(BSP_SRCS) $(CONSOLE_SRCS) $(DRIVER_SRCS) $(RASPI_SRCS)
OBJS = $(SRCS:.cpp=.o)
INCLUDES = -I ./src $(STD_INC) $(ARCH_INC) $(BSP_INC) $(CONSOLE_INC) $(DRIVER_INC) $(RASPI_INC)
CFLAGS = -Wall -O0 -g -ffreestanding -nostdinc -nostdlib -nostartfiles -fno-rtti -fno-exceptions -fno-threadsafe-statics -fno-use-cxa-atexit $(INCLUDES)
